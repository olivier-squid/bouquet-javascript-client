...
(function(root, factory) {
  ...
  describe('MetricPK', function() {
    it('should create an instance of MetricPK', function() {
      // uncomment below and update the code to test MetricPK
      //var instane = new Bouquet.MetricPK();
      //expect(instance).to.be.a(Bouquet.MetricPK);
    });
